                  ...
                  <div className="bg-white rounded-xl p-6 border border-gray-200">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="text-lg font-bold text-blue-600">{mockAnalytics.activeUsers}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm text-gray-600">New Signups Today</span>
                        <span className="text-lg font-bold text-green-600">{mockAnalytics.todaySignups}</span>
                      </div>
                    </div>
                  </div>
                </div>
